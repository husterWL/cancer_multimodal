...
true1 = np.load('./classification/draw/true_labels_unimodal_univision_0723_3.npy')
pre1 = np.load('./classification/draw/pred_scores_unimodal_univision_0723_3.npy')
true2 = np.load('./classification/draw/true_labels_multimodal_imgemr_0724_1.npy')
pre2 = np.load('./classification/draw/pred_scores_multimodal_imgemr_0724_1.npy')
true3 = np.load('./classification/draw/true_labels_multimodal_imgkg_0728_7.npy')
pre3 = np.load('./classification/draw/pred_scores_multimodal_imgkg_0728_7.npy')
